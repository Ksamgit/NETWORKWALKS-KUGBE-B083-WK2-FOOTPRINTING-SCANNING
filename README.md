...
- **256 IPs scanned** in 8.3 seconds
- **2 hosts up** (including the local scanner)
- Router identified as (`10.26.74.95`)

| # | IP Address | MAC Address | Vendor |
|---|---|---|---|
| 1 | 10.26.74.95 | `F2:AB:1F:EE:56:68` | Intel Corporate |
...
![WhatWeb Output](whatweb.jpeg.png)
...
![Wafw00f Output](wafw00f.jpeg.png)
...
Then in Zenmap:
- **Target:** `10.26.74.95/24`
- **Profile:** `Ping scan`

![Zenmap Ping Scan](ZenmapScan.png)

*Result: 2 hosts up — 10.26.74.95,221 (router)*
...
*Network topology of the 10.26.74.95/24 subnet, generated and exported from Zenmap.*
...
- 💼 [KUGBE SAMUEL](https://www.linkedin.com/in/samuel-setonji-kugbe-416733233/?lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3BVg1DgCNXTKWgQsckJZJXiA%3D%3D)
